...
function InitLevel()
	...
	CreateUnit(SolarPanel.pointer,       cur_player, 100.5,  111.5, 0)
	CreateUnit(SolarPanel.pointer,       cur_player, 112.5,  117.5, 0)

	cur_player = GetPlayerByIndex(1)
	CreateUnit(MainBuilding.pointer, cur_player, 39.5,  40.5, 0)
	CreateUnit(Builder.pointer,      cur_player, 43.5,  50.5, 0)
	CreateUnit(SolarPanel.pointer,   cur_player, 46.5,  40.5, 0)
	CreateUnit(SolarPanel.pointer,   cur_player, 31.5,  39.5, 0)
	-- CreateUnit(LargeTank.pointer,    cur_player, 37.5,  51.5, 0)
